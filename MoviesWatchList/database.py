...
load_dotenv() #it load .env file in my folder, any code after that so this \/ one (thats why we do it at the top)
...
connection = psycopg2.connect(os.environ["DATABASE_URL"]) #We connect to Database Environmental Variable
